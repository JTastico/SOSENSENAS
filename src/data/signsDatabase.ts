...
export const signsDatabase: Sign[] = [
  {
    ...
    landmarks: {
      bothHands: [
        // Frame 1 - ambas manos
        [[0.5, 0.3, 0], [0.6, 0.4, 0], [0.4, 0.2, 0], [0.3, 0.5, 0], [0.7, 0.3, 0], [0.5, 0.6, 0]],
        // Frame 2  
        [[0.51, 0.31, 0], [0.61, 0.41, 0], [0.41, 0.21, 0], [0.31, 0.51, 0], [0.71, 0.31, 0], [0.51, 0.61, 0]]
      ]
    },
    handType: 'both'
  },
